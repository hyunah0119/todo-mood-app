  ...
  return (
    <>
      ...
      >
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="todo-checkbox" className="cursor-pointer">기본</label>
          </div>
        </div>
      ...
      <div
        ...
        shadow-md px-2.5 py-2.5 box-border mb-2 transition-colors duration-200"
      >
        <div>
          <input type="checkbox" id="todo-checkbox" />
          <div className="flex items-center gap-2">
            <span className="w-3.75 h-3.75 border rounded-4xl flex justify-center items-center text-[10px] border-amber-400 bg-amber-400 text-white">
              <FaCheck />
            </span>
            <label htmlFor="todo-checkbox" className="line-through italic">완료</label>
          </div>
        </div>

        <div className="relative">
          <button className="block text-lg" onClick={handleKebabMenuToggle}><HiOutlineDotsVertical /></button>
